...
public class PlayerShooting : MonoBehaviour
{
	...
	[SerializeField] float swordPush;
	float lastSword;
	float lastShoot;
	void Start()
	{
	...
	void Update()
	{
		...
		//SWord//////////////////////////////
		if (Input.GetKey(KeyCode.Mouse1) && lastSword + meeleDelay < Time.time)
		{
	...
	void SwordAttack()
	{
		...
		if (enemy != null)
		{
			...
			//enemy.GetComponent<Rigidbody2D>().AddForce(dir * swordPush, ForceMode2D.Impulse);
		}
		lastSword = Time.time;
	}
}
